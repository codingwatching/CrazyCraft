...
execute_process(
  COMMAND "/usr/bin/git" show-ref "789f8132842536f077548bc4f2d2c3685e9f491e"
  WORKING_DIRECTORY "/home/ati/Desktop/code/lol/build/_deps/magnum-integration-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "789f8132842536f077548bc4f2d2c3685e9f491e")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("789f8132842536f077548bc4f2d2c3685e9f491e" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/789f8132842536f077548bc4f2d2c3685e9f491e")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ati/Desktop/code/lol/build/_deps/magnum-integration-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ati/Desktop/code/lol/build/_deps/magnum-integration-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/usr/bin/git" submodule update --recursive --init src
    WORKING_DIRECTORY "/home/ati/Desktop/code/lol/build/_deps/magnum-integration-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
